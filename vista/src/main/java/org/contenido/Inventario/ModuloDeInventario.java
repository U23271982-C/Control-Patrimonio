 ...
 */
package org.contenido.Inventario;
...
public class ModuloDeInventario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Categoria.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Categoria", "Equipos Tecnológicos", "Mobiliario", "Infraestructura", "Material Didáctico", "Dispositivos Electrónicos", "Equipos de oficina", "Herramientas de mantenimiento", "Bienes en almacenamiento" }));

        Estado.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Estado", "Disponible", "En uso", "Asignado", "Inactivo", "En mantenimiento", "En traslado", "Dado de baja" }));
