 ...
 * @author SERT
 */
public class ModificarCategoría extends javax.swing.JFrame {

    /**
     * Creates new form PanelCategoria
     */
    public ModificarCategoría() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarCategoría.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarCategoría().setVisible(true);
            }
        });
    }
